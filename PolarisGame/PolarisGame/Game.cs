...
namespace PolarisGame
{
    public class Game : Application
    {
        ...
        public override void OnAttach()
        {
            ...
            DrillMesh = Mesh.LoadFromModel(@"builtin/gl/tests/test1/test_assets/Drill_01.FBX");
            Drill.Mesh = DrillMesh;
            DrillMat = new Material(@"builtin\shaders\std");
            DrillTex = new Texture(@"builtin/gl/tests/test1/test_assets/Drill_01_8-bit_Diffuse.png");
